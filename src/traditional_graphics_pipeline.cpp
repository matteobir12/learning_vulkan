...
namespace {
constexpr const char* vertShaderPath = "shaders/build/vert.spv";
constexpr const char* fragShaderPath = "shaders/build/frag.spv";
...
TraditionalGraphicsPipeline::TraditionalGraphicsPipeline(const VkDevice _device, const SwapChainHandler& swapchainHandler)
 : device(_device) {
